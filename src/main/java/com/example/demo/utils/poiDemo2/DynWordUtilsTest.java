package com.example.demo.utils.poiDemo2;
...
public class DynWordUtilsTest {
    ...
    public static void main(String[] args) {
        ...
        // 模板全的路径
//        String templatePath = "G:\\Download\\poi\\审查报告模板1023体检表.docx";
        String templatePath = "G:\\Download\\poi\\附件9：反担保抵押合同（抵押人为反担保人）（3）.docx";
        // 输出位置
        String outPath = "G:\\Download\\poi\\22.docx";
        ...
        imgEntity.setUrl("G:\\Download\\poi\\test.jpg");
        ...
        imgEntity3.setUrl("G:\\Download\\poi\\test.jpg");
        ...
        imgEntity1.setUrl("G:\\Download\\poi\\test.jpg");
        ...
        imgEntity2.setUrl("G:\\Download\\poi\\test.jpg");
